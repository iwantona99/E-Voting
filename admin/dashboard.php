        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li <?php if (isset($_GET['page']) && $_GET['page'] == 'kandidat') { echo 'class="active"'; } ?>>
                <a href="?page=kandidat"><i class="fa fa-users"></i> <span>Manajemen Pemilihan</span></a>
            </li>
            <li <?php if (isset($_GET['page']) && $_GET['page'] == 'pemenang') { echo 'class="active"'; } ?>>
                <a href="?page=pemenang"><i class="fa fa-users"></i> <span>Manajemen Pemenang</span></a>
            </li>
			...
			<li <?php if (isset($_GET['page']) && $_GET['page'] == 'histori') { echo 'class="active"'; } ?>>
                <a href="?page=histori"><i class="fa fa-users"></i> <span>List Para Kandidat</span></a>
            </li>
